...
#include "lang.inc"
#if defined TARGET_tabdeve1
\integer{typedev=1}
#endif
#if defined TARGET_tabdeve2
\integer{typedev=2}
#endif
\precision{10000}
...
</table><div class="wims_instruction">\name_instruction</div></li>
}{<li>\name_enonce:
<table class="wimscenter wimsborder">
 <tr>
  <td>\(\times)</td>
...
<li>\name_enonce2:
<div class="wimscenter">\(\enonce\)= \embed{r5, 30}</div></li>
}
</ol>}

\answer{\name_answer 1}{\repco[1]}{type=litexp}{option=polexpand}{weight=1.5}
\answer{Réponse 2}{\repco[3]}{type=litexp}{option=polexpand}{weight=1.5}
\answer{Réponse 3}{\repco[2]}{type=litexp}{option=polexpand}{weight=1.5}
\answer{Réponse 4}{\repco[4]}{type=litexp}{option=polexpand}{weight=1.5}
\answer{\(\enonce\)}{\rep13}{type=litexp}{option=polexpand}{weight=4}
