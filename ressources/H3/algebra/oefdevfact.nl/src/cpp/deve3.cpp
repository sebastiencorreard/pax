...
#if #TARGET(deve3)
   \title{Werk de haakjes weg (a+b)^2 #}
   \text{signe=+}
#endif
...
\statement{<br>
Werk de haakjes weg en schrijf zo kort mogelijk &nbsp;&nbsp; \(\enonce).
<br>
<center><hr width=50%></center>
<table class=reply>
<tr><td>
<u><b>Jouw antwoord :</b></u><br>
\if{\confparm2=1}{
Je moet de opdracht als volgt uitvoeren. Sleep de verschillende onderdelen naar de juiste plek op de vraagtekens.
Let op de corresponderende kleuren.<br> Maak gebruik van de regel: \((a\signe b)^2=a^2\signe 2ab+b^2) : <p>
\if{\step=1}{<small>Gebruik de blauwe vakjes om de berekening af te maken.</small> <p>
...
\answer{Antwoord 1}{\rep1;\rep1;\rep2}{type=clickfill}
\answer{Antwoord 2}{\rep1;\rep1;\rep2}{type=clickfill}
\answer{Antwoord 3}{\rep2;\rep1;\rep2}{type=clickfill}
\answer{Antwoord 4}{\rep2;\rep1;\rep2}{type=clickfill}
\answer{Antwoord 5}{\rep[1]}{type=litexp}
\answer{Antwoord 6}{\rep[2]}{type=litexp}
\answer{Antwoord 7}{\rep[3]}{type=litexp}
\answer{Antwoord}{\rep8}{type=litexp}
