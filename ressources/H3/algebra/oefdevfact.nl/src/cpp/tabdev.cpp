...
#if #TARGET(tabdeve1)
 \title{Haakjes weg mbv tabel k(a+b)}
 \integer{typedev=1}
#endif

#if #TARGET(tabdeve2)
 \title{Haakjes weg mbv tabel (a+b)(c+d)}
 \integer{typedev=2}
#endif
...
</table><small>Elk resultaat moet zo eenvoudig mogelijk opgeschreven zijn.</small></center></li>
}{<li>Vul de tabel in :  
<center><table border=1>
 <tr height=40>
...
<li>Schrijf de volgende expressie zonder haakjes en zo eenvoudig mogelijk.<br>
Maak hierbij gebruik van bovenstaande tabel: <center>\(\enonce)</center></li>
}
</ol>}
