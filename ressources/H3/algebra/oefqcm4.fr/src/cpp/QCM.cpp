target= revision401 numerique01 numerique02
...
#if defined TARGET_revision401 
\keywords{geometry}
\title{Géométrie 1 4ème}
\matrix{enr1=wims(record 1 of revision401)}
\matrix{enr2=wims(record 2 of revision401)}
\matrix{enr3=wims(record 3 of revision401)}
\matrix{enr4=wims(record 4 of revision401)}
\matrix{enr5=wims(record 5 of revision401)}
#endif

#if defined TARGET_numerique01 
\title{Numérique 1 - 4ème}
\keywords{number}
\matrix{enr1=wims(record 1 of numerique01)}
\matrix{enr2=wims(record 2 of numerique01)}
\matrix{enr3=wims(record 3 of numerique01)}
\matrix{enr4=wims(record 4 of numerique01)}
\matrix{enr5=wims(record 5 of numerique01)}
#endif

#if defined TARGET_numerique02 
\title{Numérique 2 - 4ème}
\keywords{number}
\matrix{enr1=wims(record 1 of numerique02)}
\matrix{enr2=wims(record 2 of numerique02)}
\matrix{enr3=wims(record 3 of numerique02)}
\matrix{enr4=wims(record 4 of numerique02)}
\matrix{enr5=wims(record 5 of numerique02)}
#endif
...
\solution{Dans le tableau,les bonnes réponses sont coloriées en vert, les mauvaises en rouge
et les réponses oubliées en bleu}
