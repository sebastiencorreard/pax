...
#if #TARGET(CORreduction)
 \title{Correspondance distribution-réduction}
#endif

#if #TARGET(CORdistribution)
 \title{Correspondance distribution}
 \text{phrase=}
#endif

#if #TARGET(distrired)
 \title{Distribution-réduction}
 \text{phrase=et réduites}
#endif
...
#if #TARGET(CORreduction) || #TARGET(CORdistribution)
\text{col1=}
\text{col2=}
\for{i=1 to 4}{
...
\statement{<br>
Faire correspondre les expressions avec parenthèses avec les expressions dévéloppées \phrase correspondantes.
<center>
\embed{r1,\size}
</center>
}
