...
#if #TARGET (liaison3)
\integer{nombre=3}
\title{Wortels en getallen 3.}
#endif

#if #TARGET (liaison4)
\integer{nombre=4}
\title{Wortels en getallen 4.}
#endif

#if #TARGET (liaison5)
\integer{nombre=5}
\title{Wortels en getallen 5.}
#endif
...
\statement{Geef bij ieder getal in de linker kolom aan welk getal rechts de 
wortel ervan is.
<p><center>
\embed{reply 1,\size}
</center>
