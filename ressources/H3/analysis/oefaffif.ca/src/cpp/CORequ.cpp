...
\if{\type=1}{
\text{question=Mettez en correspondance chaque fonction avec la couleur de sa représentation graphique dans le repère ci-contre.}
\text{ord=f(x)}
\text{size=40x150x75}
}{
\text{question=Mettez en relation chaque équation avec la couleur de la droite correspondante dans le repère ci-contre.}
\text{ord=y}
\text{size=40x100x75}
}
