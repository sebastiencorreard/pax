...
#if #TARGET (classer1)
\title{Classer des fonctions A (6 fonctions).}
\integer{nbfnct=2}
\integer{nonlin=0}
\text{size=175x50x4}
#endif
...
#if #TARGET (classer2)
\title{Classer des fonctions A (9 fonctions).}
\integer{nbfnct=3}
\integer{nonlin=0}
\text{size=175x50x6}
#endif
...
#if #TARGET (classer3)
\title{Classer des fonctions B (6 fonctions).}
\integer{nbfnct=2}
\integer{nonlin=1}
\text{size=175x50x4}
#endif
...
#if #TARGET (classer4)
\title{Classer des fonctions B (9 fonctions).}
\integer{nbfnct=3}
\integer{nonlin=1}
\text{size=175x50x6}
#endif
...
\text{enonceaffine=non linéaires}
}

\statement{<br>
Classer les fonctions suivantes suivant leur nature : <ul>
<li>Fonctions linéaires : <br>
\embed{r1,\size}</li>
<li>Fonctions affines \enonceaffine: <br>
\embed{r2,\size}</li>
<li>Fonctions non affines : <br> 
\embed{r3,\size}</li>
</ul>
}

\reply{Liste des fonctions linéaires}{\replin;\list}{type=clickfill}
\reply{Liste des fonctions affines \enonceaffine}{\repaff;\list}{type=clickfill}
\reply{Liste des fonctions non affines}{\repaut;\list}{type=clickfill}
...
\condition{Fonctions affines \enonceaffine :}{\aff1=\tmp and \aff2=\tmp}
