...
#define TITRE Classificare funzioni
#if defined TARGET_classer1
\title{TITRE A (6 funzioni)}
\integer{nbfnct=2}
\integer{nonlin=0}
\text{size=175x50x4}
#endif
...
\text{enonceaffine= non lineari}
}

\statement{
Classificare le funzioni seguenti in base alla loro natura: <ul>
<li>Funzioni lineari:
\embed{r1,\size}</li>
<li>Funzioni affini\enonceaffine:
\embed{r2,\size}</li>
<li>Funzioni non affini:
\embed{r3,\size}</li>
</ul>
}

\reply{Lista delle funzioni lineari}{\replin;\list}{type=clickfill}
\reply{Lista delle funzioni affini\enonceaffine}{\repaff;\list}{type=clickfill}
\reply{Lista delle funzioni non affini}{\repaut;\list}{type=clickfill}
...
\condition{Funzioni lineari}{\lin1=\nbfnct and \lin2=\nbfnct}
...
\condition{Funzioni affini\enonceaffine}{\aff1=\tmp and \aff2=\tmp}
...
\condition{Funzioni non affini}{\aut1=\nbfnct and \aut2=\nbfnct}
