target = course04_1 course04_1step course04_2 course04_2step
...
#define KEYWORD1 calculation,equations,mental_calculation,conversion,time,division,proportionality,subtraction,fraction,pbsolving,number_writing,divisibility,multiplication,coordinates
#define KEYWORD2 mental_calculation,conversion,geometry,lines,time,decimals,length,methodical_calculation,number_line,division,masse,proportionality,volume,subtraction,pbsolving,number_writing,divisibility,multiplication,coordinates,area

#include "instruction_cycle4.inc"

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#if defined TARGET_course04_1 || defined TARGET_course04_1step
# include "0401.inc"
\text{enonce1=\enonce}
...
#endif
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#if defined TARGET_course04_2 || defined TARGET_course04_2step
# include "0416.inc"
\text{enonce1=\enonce}
\text{enonceb1=\enonceb}
\text{rep1=\rep}
...
#if defined TARGET_course04_1step
\title{TITLE 04 part.1 (step)}
\observation{Questions 0401 à 0415. Course aux Nombres de mai 2022 (académie de Strasbourg) pour des élèves de CM1. <br>A partir du module, vous pouvez modifier cette Course pour ne prendre que certaines questions.}
\keywords{KEYWORD1}
#define ALL 1
#endif
#if defined TARGET_course04_1
\title{TITLE 04 part.1}
\observation{Questions 0401 à 0415. Course aux Nombres de mai 2022 (académie de Strasbourg) pour des élèves de CM1. <br>A partir du module, vous pouvez modifier cette Course pour ne prendre que certaines questions.}
\keywords{KEYWORD1}
#define ALL 0
#endif

#if defined TARGET_course04_2step
\title{TITLE 04 part.2 (step)}
\observation{Questions 0416 à 0430. Course aux Nombres de mai 2022 (académie de Strasbourg) pour des élèves de CM1. <br>A partir du module, vous pouvez modifier cette Course pour ne prendre que certaines questions.}
\keywords{KEYWORD2}
#define ALL 1
#endif
#if defined TARGET_course04_2
\title{TITLE 04 part.2}
\observation{Questions 0416 à 0430. Course aux Nombres de mai 2022 (académie de Strasbourg) pour des élèves de CM1. <br>A partir du module, vous pouvez modifier cette Course pour ne prendre que certaines questions.}
\keywords{KEYWORD2}
#define ALL 0
#endif
...
#if defined TARGET_course04_1 || defined TARGET_course04_1step
%%%%%% Questions 0414 avec deux champs de réponse.
\matrix{STEP=wims(replace item reply 14 by reply 14,reply 16 in \STEP)}
\integer{rg14=position(14,\choix)}
%%%%%% Question 0408 sans taille de réponse (checkbox)
...
\steps{\STEP}
%%%%%% Question 0426 sans taille de réponse (mark)
    ...
    <div class="wims_question">
     ...
     \if{\step=\rg8}
      ...
      autofocus  }
        ...
        \enonceb[\choix[\j];]
      \if{\step=\rg14}{\embed{reply 16,10} \enonce0414c}
#endif
#if defined TARGET_course04_2step
       \enonce[\choix[\j];]
       \if{\step=\rg5}{\embed{reply 5,400x200 
                      id1 brd [responsive center min=250px max=400px scroll]
                      \jsxscript}}
                     {\if{\step=\rg11}{\embed{reply 11}}{
                             \embed{r\choix[\j],10
                              autofocus  }
                              \enonceb[\choix[\j];]}
                     }
...
\for{j=1 to \cnt}{
  ...
  \if{\j=\rg14}{\embed{reply 16,10} \enonce0414c}  
#endif  
#if defined TARGET_course04_2
...
#if defined TARGET_course04_1step || TARGET_course04_1
\text{list_cond=12 isitemof \choix?1,2:}
#if defined TARGET_course04_1step
...
\answer{}{\rep11}{type=formal}{option=\confparm2 comma default=0}
\answer{}{\reponse12}{type=numeric}{option=\confparm2 comma default=0}
...
%%%% question 0414
\answer{}{\repb}{type=numeric}{option=\confparm2 comma default=0}
%%%%%% condition pour question 0412
\condition{\reponse12 = \(\frac{\a0412}{\b0412}\) ?}{\reponse12=\a0412/\b0412}
\condition{\reponse12 est une autre écriture de \(\frac{\a0412}{\b0412}\) ?}{\reponse12 notsametext \a0412/\b0412}
%%%%%%%%%%%% fin condition pour question 0412
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
#endif
#if defined TARGET_course04_2step || TARGET_course04_2
...
#if defined TARGET_course04_1step || defined TARGET_course04_2step
