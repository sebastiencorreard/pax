...
segment -12,-15,12,-15,red
segment \l1,\l2,\l3,\l4,red
...
\name_enonce
<p>
\([MN] \sslash [BC]\) ; \(AB = \l9\) \(cm\) ; \(AM = \l10\) \(cm\) ; \(MN = \l11\) \(cm\).
</p>
\name_question[1] \([BC]\) (\name_question[2] \(cm\))?}
...
\name_enonce
<p>
\([MN] \parallel [BC]\) ; \(AB = \l9\) \(cm\) ; \(AM = \l10\) \(cm\) ; \(MN = \l11\) \(cm\).
</p>
\name_question[1] \([BC]\) (\name_question[2] \(cm\)) ?
\par
\dessintikz
