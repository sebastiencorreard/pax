target= parat1-mod parat2-mod parap1-mod parap2-mod
...
#if #TARGET (parap2-mod) | #TARGET (parap1-mod)
...
#if #TARGET (parat2-mod) | #TARGET (parat1-mod)
\text{rep=\X1\X5,\X1\X3,\X1\X4,\X1\X2,\X4\X2,\X5\X3}
