...
\text{comp=Les deux droites rouges sont parallèles.}
\integer{xrange=200}
\integer{yrange=200}
...
\comp
<p>
Quelles égalités de rapports peut-on écrire ?</p>
<b>Votre réponse :</b>
...
<div class="wims_instruction"> Utiliser les étiquettes ci-dessous pour complèter les égalités.</div>
 </div>
</div>
}
