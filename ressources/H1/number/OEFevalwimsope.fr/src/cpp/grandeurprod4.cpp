target=oefgrandeurprod4
#include "author.inc"
#define NUM 4
#include "lang_titles.inc"
#include "lang.inc"

\text{list=1,0.1,0.01,0.001,0.000 1}
...
\text{e=0,0,0}
\for{i=1 to 8}{
  \text{f=randint(1-\g..2-\g)}
  \text{e=wims(append item \f to \e)}}
\integer{e=randomitem(\e)}

\real{nb1=(randint(110..990))}
\real{nb2=(randint(110..990))}
...
\text{rep1=\list1[\g-\gg+1]}
\text{rep2=\list2[\e+\g-\ee+1]}
\text{rep3=\list3[2*\g+\e-\gg-\ee+1]}
...
<table class="wimscenter wimsnoborder">
 ...
 <th>\name_enonce2[1]</th>
  ...
  <td><span class="larger">\(\sg)</span></td>
  <td><span class="larger">\embed{r2,\size}</span></td></tr>
</table>
<div class="wims_instruction">\name_warning</div>
<div class="spacer">
\name_enonce2[2] \embed{r3,8}
</div>
}
