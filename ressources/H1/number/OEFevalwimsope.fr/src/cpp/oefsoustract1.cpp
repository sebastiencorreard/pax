target=oefsoustract1
#include "author.inc"
#define NUM 1
#include "lang_titles.inc"
#include "lang.inc"

\text{ch1=randint(5..9),randint(4..9),randint(3..9),randint(1..5)}
\text{ch2=randint(2..\ch1[1]),randint(3..\ch1[2]),randint(1..\ch1[3])}
...
\text{rep=}
\text{chif=}
\for{i=1 to 4}{\text{chif=wims(char \i to \i of \res)}
