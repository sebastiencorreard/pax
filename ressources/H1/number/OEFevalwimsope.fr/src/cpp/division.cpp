...
\text{row2=wims(makelist <td></td> for x=\row2+1 to \ltr-1)}
\text{row3=wims(makelist <td></td> for x=\row3+1 to \ltr-1)}
\text{row4=wims(makelist <td></td> for x=\row4+1 to \ltr-1)}
\text{row5=wims(makelist <td></td> for x=\row5+1 to \ltr-1)}
\text{row6=wims(makelist <td></td> for x=\row6+1 to \ltr-1)}
\text{row7=wims(makelist <td></td> for x=\row7+1 to \ltr-1)}
\text{row8=wims(makelist <td></td> for x=\row8+1 to \ltr-1)}
\text{row9=wims(makelist <td></td> for x=\row9+1 to \ltr-1)}
\text{row10=wims(makelist <td></td> for x=\row10+1 to \ltr-1)}
\text{row11=wims(makelist <td></td> for x=\row11+1 to \ltr-1)}
...
\text{row6=wims(items2words \row6)}
\text{row7=wims(items2words \row7)}
\text{row8=wims(items2words \row8)}
\text{row9=wims(items2words \row9)}
\text{row10=wims(items2words \row10)}
\text{row11=wims(items2words \row11)}
\statement{\name_enonce:
<div class="wims_instruction">\name_warning</div>
<table class="wimscenter">
  <tr>
    <td></td>
    \for{a=1 to 4}{<td><span class="larger">\ldd[5-\a]</span></td>}
    <td></td>
    <td colspan="1" rowspan="12" style="width:1px;height:200px;background-color:black;"></td>
    <td></td><td><span class="larger">\d2</span></td>
    <td><span class="larger">\d1</span></td>
    \row1
  </tr><tr>
    \for{a=1 to 6}{<td></td>}
    <td colspan="4"><hr></td>
    ...
    <td>\sgn</td><td>\embed{r1,\size}</td><td>\embed{r2,\size}</td>
    \for{a=1 to 4}{<td></td>}
    <td>\embed{r3,\size}</td>
    <td>\embed{r4,\size}</td>
    <td>\embed{r5,\size}</td>
    ...
    <td></td><td colspan="2" rowspan="1"><hr></td>
    \row4
  </tr><tr>
    <td></td><td>\embed{r6,\size}</td><td>\embed{r7,\size}</td><td>\embed{r8,\size}</td>
    \row5
  </tr><tr>
    <td>\sgn</td><td>\embed{r9,\size}</td><td>\embed{r10,\size}</td><td>\embed{r11,\size}</td>
    \row6
  </tr><tr>
    <td></td><td colspan="3" rowspan="1"><hr></td>
    \row7
  </tr><tr>
    <td></td><td></td><td>\embed{r12,\size}</td><td>\embed{r13,\size}</td><td>\embed{r14,\size}</td>
    \row8
  </tr><tr>
    <td></td><td>\sgn</td><td>\embed{r15,\size}</td><td>\embed{r16,\size}</td><td>\embed{r17,\size}</td>
    \row9
  </tr><tr>
    <td></td><td></td><td colspan="3" rowspan="1"><hr></td>
    \row10
  </tr><tr>
    <td></td><td></td><td></td><td>\embed{r18,\size}</td><td>\embed{r19,\size}</td>
    \row11
  </tr>
</table>}
