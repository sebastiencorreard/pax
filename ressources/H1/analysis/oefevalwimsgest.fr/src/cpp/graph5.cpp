...
#include "author.inc"
\precision{10000}
#if defined TARGET_oefgraph5
# define NUM 5
#endif
#include "lang_titles.inc"
#include "lang.inc"
\text{effs=randint(10..25)}
\for{k=1 to 9}{\integer{n=randint(-5..+5)}
\if{\effs[\k]+\n>=0 and \effs[\k]+\n<=30}{
  \integer{b=\effs[\k]+\n}
  \text{effs=\effs,\b}
}{
...
\text{reps=wims(sort numeric items \effs)}
...
\text{pic=draw(506,308,
  ...
  text black,18.6,0.8,medium,Jours
...
\name_instruction[2;]:
<ul>
<li><label for="reply1">\name_instruction[3;]</label> \embed{r1,3} °C.</li>
<li><label for="reply2">\name_instruction[4;]</label> \embed{r2,3} °C.</li>
</ul>
</div></div>
}
\answer{}{\reps[1]}{type=numeric}
\answer{}{\reps[10]}{type=numeric}
