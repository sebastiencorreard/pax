target=oefgraph3 oefgraph4
#include "author.inc"
\precision{10000}
#if defined TARGET_oefgraph3
# define NUM 3
#endif
#if defined TARGET_oefgraph4
# define NUM 4
#endif
...
\if{\a=1}{
  \integer{rep=\effs[1]+\effs[2]+\effs[3]}
  \text{cons=\name_pm[2]}
}{
  \integer{rep=\effs[4]+\effs[5]+\effs[6]}
  \text{cons=\name_pm[1]}
}
...
\text{pic=draw(506,308,
  ...
  text black,18.6,0.8,medium,Notes
  text black,0.5,7.9,medium,Nbre
  \gradu
\bat1
\bat2
\bat3
...
#if defined TARGET_oefgraph3
<ul>
<li><label for="reply1">\name_question \n1 ?</label> \embed{r1,5}</li>
<li><label for="reply2">\name_question \n2 ?</label> \embed{r2,5}</li>
</ul>
#endif
#if defined TARGET_oefgraph4
...
#if defined TARGET_oefgraph3
\answer{}{\effs[\a[1]]}{type=numeric}
\answer{}{\effs[\a[2]]}{type=numeric}
#endif
#if defined TARGET_oefgraph4
