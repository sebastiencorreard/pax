target=dicteeniv1 dicteeniv2 dicteeniv3 dicteeniv4
#define TITRE Les noms de la marine.
#if defined TARGET_dicteeniv1
 \title{TITRE Niveau facile. (D)}
 \text{data=wims(record 1 of nomsdemarinecorniv1)}
#endif
#if defined TARGET_dicteeniv2
\text{data=wims(record 1 of nomsdemarinecorniv2)}
\title{TITRE Niveau moyen. (D)}
#endif
#if defined TARGET_dicteeniv3
\text{data=wims(record 1 of nomsdemarinecorniv3)}
 \title{TITRE Niveau difficile. (D)}
#endif
#if defined TARGET_dicteeniv4
\text{data=wims(record 1 of nomsdemarinecorniv4)}
\title{TITRE Niveau excellent. (D)}
#endif

%%Le source de cet exercice a été créé à l'aide de Quicktool
%%Le type de l'exercice est GAP.
%% Vous pouvez le modifier si vous désirez l'adapter.
%% Sun May 8 12:07:47 2011

%%%%%%
\author{Anne, Dumont-Védrines; Sylvain, Dumont}
\email{annel.vedrines@laposte.net}
...
\text{format=case}
\text{format0=mark}
\text{specialhelp1=\confparm2=1 ? 5}
\text{specialhelp2=}
\text{specialhelp3=}
\text{specialhelp4=}
\text{helpprompt=}
...
\text{autocompletion=\format iswordof nocase case raw ? autocomplete="off"}
...
seulement N=1
 \for{i = 1 to \N}{
   \text{texte=randomrow(wims(record 1 of \file0))}
   \text{texte=wims(embraced randitem \texte)}
\text{article=wims(word 1 of wims(replace internal l' by l' \ in \texte))}
   \if{\article iswordof le de l' un une la des}{
     \text{texte=\article issametext l' ? wims(replace internal l' by in \texte):
   wims(word 2 to -1 of \texte)}
   }{ \text{article=}}
...
\matrix{rep=\format iswordof nocase case raw? wims(replace internal &#44; by , in \rep)}
...
\text{trouV=\format iswordof nocase case raw? } mettre une option
\statement{\nopaste \instruction
  \if{\reading notsametext }{\special{help reading,[à lire]}}
  \if{\image notsametext }{\special{help image,[à regarder]}}
  \audio\video
  <div class="question">
\if{\format iswordof nocase case raw dragfill clickfill}
   {
   \for{k = 1 to \cntQ}{ \article
...
\if{\format iswordof mark}{
  \for{k = 1 to \cntQ}{
   ...
   {
   \if{\answer_given=yes}{<span class="oef_indgood">\trouV[\k;\rep[\k;1]]</span>}
   <span class="oef_indbad"><strike>\repl[\k;]</strike></span>}
   }
  }
  \texte[2*\cntQ+1;]
}
...
\if{\choix notsametext and \format iswordof case nocase raw}{
<div class="reponse">\choix</div>
}
}

\answer{}{\rep[1;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[2;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[3;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[4;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[5;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[6;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[7;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[8;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[9;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[10;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[11;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[12;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[13;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[14;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[15;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[16;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[17;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[18;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[19;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[20;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[21;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[22;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[23;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[24;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[25;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[26;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[27;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[28;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[29;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[30;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[31;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[32;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[33;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[34;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[35;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[36;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[37;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[38;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[39;]}{type=\format}{option=shuffle \option_reaccent nonstop}
\answer{}{\rep[40;]}{type=\format}{option=shuffle \option_reaccent nonstop}
...
\text{nstep=}
\if{\step<=\try}{
  \for{i=1 to \cntQ}{\text{nstep= \screply[\i]!=1 ? \nstep,r \i}}
}
