...
\text{t3=J'en déduis que AK = BK.}
\text{t4=De plus&#44; Le point K appartient aussi à la médiatrice du segment [AC].}
\text{t5=Donc le point K est à égale distance des deux extrémités du segment.}
\text{t6=J'en déduis que AK = CK.}
\text{t7=Donc AK = BK = CK}
...
<li>\embed{r2,520x40}</li>
<li>\embed{r3,520x40}</li>
<li>\embed{r4,520x40}</li>
<li>\embed{r5,520x40}</li>
<li>\embed{r6,520x40}</li>
<li>\embed{r7,520x40}</li>
<li>\embed{r8,520x40}</li>
</ul>
}
