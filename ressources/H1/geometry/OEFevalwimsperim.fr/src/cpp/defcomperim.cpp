target=oefdefcomperim1 oefdefcomperim2 oefdefcomperim3 oefdefcomperim4 oefdefcomperim5
\keywords{perimeter}

#include "author.inc"
#include "lang_titles.inc"
#include "lang.inc"
#if defined TARGET_oefdefcomperim1
\text{typ=radio}
\integer{a=8}
\integer{b=7}
\integer{lo=40}
...
\real{r5=\g*\h/2}
\integer{ch=1}
\text{rep=\r1 cm,\r2 cm,\r3 cm,\r4 cm,\r5 cm}
\integer{large=4}
...
\t1}}
#endif
#if defined TARGET_oefdefcomperim2
\text{typ=radio}
\real{lo=34.64}
\integer{xo=10}
\integer{yo=290}
...
\integer{r1=3*\f+\g*2}
\integer{r2=0}
\for{i=1 to \f}{\integer{r2=(\g+\i-1)*2+1+\r2}}
...
\t1}}
#endif
#if defined TARGET_oefdefcomperim3
\text{typ=menu}
...
\integer{ch=\ch[\n]}
#endif
#if defined TARGET_oefdefcomperim4
\text{typ=menu}
\integer{a=16}
\integer{b=14}
\integer{lo=20}
...
\text{rep=\name_rep}
#endif
#if defined TARGET_oefdefcomperim5
\text{typ=menu}
\integer{a=16}
\integer{b=14}
\integer{lo=20}
