...
\name_enonce[1]:
<div class="wimscenter">a = \mes1 mm, b= \mes2 mm, c = \mes3 mm.</div>
\name_enonce[2]
<p>\name_question?
</p><div class="spacer"><label for="reply1">Longueur :</label> \embed{r1,3} mm,
<label for="reply1">largeur :</label> \embed{r2,3} mm,
<label for="reply1">hauteur :</label> \embed{r3,3} mm</div></div>
</div>
}
