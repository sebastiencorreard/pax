...
function make_plinko(xsize,ysize,fillcolor,strokecolor,fontsize){
 ...
 for(var p = 0 ; p < len ;p++){
  ...
  totaal_ballen=totaal_ballen+plinko_data[p];
 };
};

function make_data_table(name_class,name_ball,name_bin,sigma){
 var table_div = document.getElementById('table_div');
 table_div.style.display = 'block';
 var table="<table><tr><th><table class="+name_class+"><tr><th>"+name_bin+"</th>";
 ...
 table+="</tr></table></th></tr><tr><th style='background-color:orange;font-size:1.5em;'>&sigma; = "+sigma.toFixed(1)+"</th></tr></table>";
