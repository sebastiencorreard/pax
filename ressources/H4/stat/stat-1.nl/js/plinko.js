<script type="text/javascript">
    ...
    var rem1="$rem1";var rem2="$rem2";var rem3="$rem3";var rem4="$rem4";var rem5="$rem5";var rem6="$rem6";var rem7="$rem7";var rem8="$rem8";var rem9="$rem9";
	...
	if(done == 0){
	    var time=rem3;var freq=rem4;
    	    var d=document.getElementById("Ballenbak").ReadApplet();if(d.indexOf('error')!= -1){setAlarm(rem1+"\n"+"\""+d+"\"");return;}
...
<object classid="java:Plinko.class" type="application/x-java-applet;jpi-version=1.4" id="Ballenbak" width="220" height="100" ><param name="java_codebase" value="$appletdir" /><param name="java_archive" value="Plinko.jar" /><param name="java_code" value="Plinko.class" /><param name="wims_exercise" value="1"/><param name="xsize" value="$xsize"/><param name="ysize" value="$ysize"/><param name="fontsize" value="12"/><param name="bins" value="$var1"/><param name="chance" value="$var4"/><param name="speed" value="$var3"/><param name="title" value="Applet created by Dr. D.P. Little"/><param name="language" value="$taal"/><param name="balls" value="$var2"/>$nojava</object>
