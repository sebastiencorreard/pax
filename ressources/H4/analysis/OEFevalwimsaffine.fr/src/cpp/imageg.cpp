target=imageg1,imageg2,imageg3,imageg4,imageg5
#include "author.inc"
\precision{100}
#if defined TARGET_imageg1
# define NUM 1
#endif
#if defined TARGET_imageg2
# define NUM 2
#endif
#if defined TARGET_imageg3
# define NUM 3
#endif
#if defined TARGET_imageg4
# define NUM 4
#endif
#if defined TARGET_imageg5
# define NUM 5
#endif
...
<div class="wimscenter"><img src="\figure" alt=""></div>
  Quelle est l'image de \a par cette fonction ?
<p><b>Votre réponse :</b></p>
<div class="wimscenter">
<label for="reply1">\(\f(\a) =)</label> \embed{r1,5}.
</div>}

\answer{réponse}{\b}{type=numexp}
