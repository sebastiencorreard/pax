...
: <small>Klik hier</a> voor een illustratie</small>
...
: Typ je wiskundige antwoord in<br>klik op de knop,<br> en je krijgt de wiskundige formule te zien <br>zoals WIMS deze interpreteerd.
