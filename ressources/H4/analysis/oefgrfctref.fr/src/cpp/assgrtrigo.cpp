target=assgrtrigo1 assgrtrigo2
...
\text{aList=-2,-1,1,2}
#if defined TARGET_assgrtrigo1
\text{bList=-4,-3,-2,-1,-1/2,-1/3,1/3,1/2,1,2,3,4}
\text{cList=0}
#endif
#if defined TARGET_assgrtrigo2
...
####### enoncé de l'exo #######
\statement{
 \name_enonce <div class="wimscenter">
  \embed{reply 1,\taille}
</div>
}
