...
!if $wims_user = supervisor
    <th>
	<input style="background-color:#ff9900;font-weight:normal;font-size:16px;text-align:center;" type="button" name="$wims_firstname $wims_lastname" value="antwoorden : $wims_firstname $wims_lastname" onclick="javascript:showAnswer()"/>
    </th>
!endif
    <th>
