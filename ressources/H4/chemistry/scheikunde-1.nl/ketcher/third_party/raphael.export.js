...
(function(R) {
	...
	*/
	...
	R.fn.toSVG = function(scale) {
		var	
			paper   = this,
			w	= parseInt(0.8*scale*paper.width),
			h	= parseInt(0.8*scale*paper.height),
			restore = { svg: R.svg, vml: R.vml },
			svg     = '<svg style="overflow: hidden; position: relative;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="' + w + '" version="1.1" height="' + h + '"><g transform="scale('+scale+')">'
		R.svg = true;
		R.vml = false;
