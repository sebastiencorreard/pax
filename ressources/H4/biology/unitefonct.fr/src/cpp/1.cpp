...
:\title{A-Étude d'une réaction biologique (cellules de levures)}
:\author{Jonathan, Faivre}
:\email{prof.svt.lc@gmail.com}
:\credits{J. Faivre}
:Instruction Globale
Tapez ici une instruction commune à toutes les questions de l'exercice
help
\text{instruction=Répondez aux questions pour mettre en évidence une réaction biologique réalisée par les levures.}
...
<ul>
<li><code>Qtitle</code> : affiche un titreau début de la question. (par exemple pour indiquer le thème)</li>
<li><code>Qimage</code> : si un fichier d'image est indiqué, celle-ci sera affichée au debut de la question. (ne fonctionne que dans un module ou une classe)</li>
<li><code>Qaudio</code> : si un fichier son est indiqué, celui-ci sera affichée au debut de la question. (ne fonctionne que dans un module ou une classe. Bugs connus avec Safari)</li>
</ul>
<div style="border-left:2px solid orange;width:45em;background-color:white;padding:1em .5em;">Exemple : <br>
...
Proposition n°2
Proposition n°3</pre></div>
\text{data_dessin=5.5,4.5,3.1,2.2,0.5,0}
\text{molecule=dioxygène}
#include "diagram.inc"
\text{dessinlist=\dessin}
\text{data1=asis(
Sur le graphique ci-dessus on peut voir que :
Les données chiffrées sont primordiales lorsque vous décrivez l'évolution d'un paramètre (par exemple la concentration de dioxygène) en fonction d'un autre.
3
Le paramètre mesuré est la concentration de glucose.
Le paramètre variable est la concentration en glucose.
Le paramètre variable est la présence ou non de glucose.
Le temps est le paramètre fixe.
Le paramètre variable est la présence ou non de levure.)}

:Question 2

\text{data2=asis(Sur le graphique ci-dessus, on peut voir que:
Observez bien les unités des axes des abscisses et des ordonnées
4
la concentration en dioxygène passe de 6,5 g / L à 0,5 g / L entre la 2ème et la 6ème minute.
la concentration en dioxygène passe de 6,5 mg / mL à 0,5 mg / mL entre la 2ème et la 6ème minute.
la concentration en dioxygène passe de 6,5 g / mL à 0,5 g / mL entre la 2ème et la 6ème minute.
la concentration en dioxygène passe de 6,5 mg / L à 0,5 mg / L entre la 2ème et la 6ème minute.)}

:Question 3

\text{data3=asis(Sur le graphique on comprend que :
3
l'expérience témoin est la mesure de la concentration de dioxygène entre 2 et 6 minutes.
l'expérience témoin est la mesure de la concentration de dioxygène entre 3 et 5 minutes.
l'expérience témoin est la mesure de la concentration de dioxygène entre 0 et 2 minutes.
l'expérience témoin est la mesure de la concentration de dioxygène entre 0 et 6 minutes.)}

:Question 4

\text{data4=asis(En consultant le graphique on peut en déduire que :
2
le dioxygène est produit en présence de glucose.
le dioxygène est consommé en présence de glucose.
le dioxygène est produit en absence de glucose.
le dioxygène est consommé en absence de glucose.)}

:Question 5

\text{data_dessin=5.5,6.5,8,11,13,13}
\text{molecule=dioxyde de carbone}
#include "diagram.inc"
\text{dessinlist=\dessinlist,\dessin}
\text{data5=asis(
Sur le graphique ci-dessus, on peut voir que :
Observez bien les unités des axes des abscisses et des ordonnées
2,3,4
la concentration en dioxyde de carbone passe de 5,5 mg / L à 7,5 mg / L entre la 2ème et la 3ème minute.
la concentration en dioxyde de carbone passe de 5,5 mg / L à 11 mg / L entre la 2ème et la 5ème minute.
la concentration en dioxyde de carbone passe de 5,5 mg / L à 8 mg / L entre la 2ème et la 4ème minute.
la concentration en dioxyde de carbone passe de 5,5 mg / L à 6,5 mg / L entre la 2ème et la 3ème minute.)}

:Question 6

\text{data6=asis(En consultant le graphique on peut en déduire que :
1
le dioxyde de carbone est produit en présence de glucose.
le dioxyde de carbone est consommé en présence de glucose.
le dioxyde de carbone est produit en absence de glucose.
le dioxyde de carbone est consommé en absence de glucose.)}

:Question 7

\text{data7=asis(En mettant en relation les deux graphiques on peut voir que :
3,6
la levure réalise une transformation chimique qui consomme du dioxygène et du dioxyde de carbone.
la levure réalise une transformation chimique qui consomme du dioxyde de carbone et du glucose.
la levure réalise une transformation chimique qui consomme du dioxygène et du glucose.
la levure réalise une transformation chimique qui rejette du dioxygène et du glucose.
la levure réalise une transformation chimique qui rejette du dioxyde de carbone et du glucose.
la levure réalise une transformation chimique qui rejette du dioxyde de carbone.)}

:Question 8

\text{data8=asis(La réaction chimique réalisée par le levure se nomme :
1
la respiration cellulaire.
la photosynthèse.
l'alvéorespiration cellulaire.
la thermorespiration cellulaire.)}
...
\text{style = <style type="text/css">
 ...
 .oef_indpartial{color:navy;} #answeranalysis{display:none;}
 </style>
}
  ...
  \for{h=1 to \etape[\step]}{
   ...
   \if{(\h <= \etape[\step] - \N or r \h isitemof \nstep) and \question[\h;] notsametext }{
     <div class="enonce">
       ...
       <div class="preliminaire">\PRELIMINAIRE[\h;]
       \if{\h=1}{\dessinlist[1]}
       \if{\h=5}{\dessinlist[2]}
       </div>
