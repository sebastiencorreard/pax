...
\text{listeint=wims(append word <td>\(\i1\leq x <\i2)</td> to \listeint)}
...
\text{h1=item(item(1,\U),\liste)}
\text{h1=wims(declosing \h1)}
\text{h2=item(item(2,\U),\liste)}
\text{h2=wims(declosing \h2)}
\text{h3=item(item(3,\U),\liste)}
\text{h3=wims(declosing \h3)}
\text{h4=item(item(4,\U),\liste)}
...
<tr>
<td>\draw{220,150}{\h1}</td>
<td>\draw{220,150}{\h2}</td>
<td>\draw{220,150}{\h3}</td>
<td>\draw{220,150}{\h4}</td>
</tr><tr>
