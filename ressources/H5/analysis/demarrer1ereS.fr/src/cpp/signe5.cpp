...
\text{choix=(\err==1 and \cas notin 2,6) or (\err==0 and \cas isin 1,5)?\name_choix,
  \name_choix2
}
...
\text{choix=wims(replace internal VVVV by \V in \choix)}
\text{choix=wims(replace internal WWWW by \W in \choix)}

\statement{
<div class="monenonce">\name_enonce
<div class="wimscenter">\({}f(x) = \Fc\).</div>
 \table
\name_question[1;]? \name_question[2;]
</div>
<ul class="wims_nopuce">
\for{i=1 to \cnt}{<li>\embed{reply1,\i}</li>}
</ul>
}
...
{<div class="macorrection" style="color:green"><b>\name_retain</b> :
  \name_feed2[1] \(\s) \name_feed2[2]
\if{\k==1}{\name_posneg[1]}{\name_posneg[2]}, \name_feed2[3] \(x\).</div>}
...
<div class="macorrection" style="color:green"><b>\name_retain</b> :
\name_feed3[1] \(\t\)
\name_feed3[2] \(a^2 - b^2= (a-b)(a+b)\).</div>}
