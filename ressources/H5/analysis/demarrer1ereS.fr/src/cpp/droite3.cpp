target=droite3
%% droites parallèles par les coeff dir
\language{fr}
\range{-5..5}
\computeanswer{no}
\format{html}
...
\answer{}{\rep2;\name_choix[2;]}{type=menu}
\answer{}{\rep2;\name_choix[3;]}{type=menu}
\answer{}{\rep7;\name_choix[4;]}{type=menu}
\answer{}{\ok;\name_choix[5;]}{type=menu}
...
\if{\rep7==3}{
  On a deux droites non verticales de pentes \if{\ok==1}{égales}{différentes}
  \(m_1=\m\) et \(m_2=\m2\).}
\if{\rep7==1}{L'une des droites est verticale et pas l'autre.
