...
%%%%% Mots clefs
#define KEYWORD quizz,power,calculation,multiplication,division,scientific_notation,conversion,length,skill_modelling,literal_calculation,inequations,affine_function,equations,graphing,percentage,percents,fraction,intervals,functions,histogram
...
\title{Course d'automates T 1}
\observation{codé à partir du sujet zéro sujet-techno-1_0.pdf publié en 2025 sur Eduscol}
