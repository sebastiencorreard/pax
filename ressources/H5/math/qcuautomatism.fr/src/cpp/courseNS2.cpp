...
%%%%% Mots clefs
#define KEYWORD 
quizz,skill_calculate,conversion,literal_calculation,percentage,percents,functions,reference_function,slope,straight_line,mean,standard_deviation
%%%%%%  toutes les questions
#include "question124.inc"                                  
\text{qen1=\enonce}
