...
%%%%% Mots clefs
#define KEYWORD quizz,fraction,time,conversion,skill_calculate,decimals,literal_calculation,trinomial,percentage,percents,functions,affine_function,reference_function,median,mean
%%%%%%  toutes les questions
#include "question404.inc"                                  
\text{qen1=\enonce}
...
\title{Course d'automates NS 1}
\observation{codé à partir du sujet zéro sujet-specifique-1_0.pdf publié en 2025 sur Eduscol}
\keywords{#KEYWORD}
...
\answer{}{\ng3;\(E\),\(F\),\(G\),\(H\)}{type=radio}{option=\confparm3 nolegend noanalyzeprint}
