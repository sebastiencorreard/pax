...
\text{ll=wims(sort numeric list \ll)}
...
\real{x2=(\n>1 and \casf<5)?\sol[2]}
/**Correction par Erice Reyssat de mars 2025 : remplacer listsort de pari - tri alphabétique !- par le tri de wims **/
\text{ll=wims(sort numeric list \sol)}
\real{x1=(\n>1 and \casf>4)?pari(0.1*floor(10*\ll[1]))}
...
<!-- début de la colonne droite : liste des questions -->
<ol>
\if{\step==1}{<li><strong>\name_question1 \(\mathcal{D}\)?
  </strong>\embed{reply1, 5}</li>}
\if{\step==2 and \casf!=5 and \n==0}{
  <li style="margin-botton:5px">
    \name_question2 \(\mathcal{D}\).
  </li>
  <li><strong>\name_complete:</strong>
  <table class="wimsborder">
  <tr>
  <td style="width:5%">\(x)</td><td style="text-align:left;width:40%">-\xsize</td>
  <td style="text-align:right;width:40%">\xsize</td>
  </tr><tr>
  <td style="width:5%">\(f(x))</td><td colspan="2" style="text-align:center">\embed{reply2}</td>
  </tr>
  </table></li>
}
\if{\step==2 and \casf==5 and \n==0 }{
  <li style="margin-botton:5px">
  \name_question3[1] \(\mathcal{D}\).
  <br>\name_question3[2] \a.
  </li><li><strong>\name_complete:</strong>
  <table class="wimsborder">
  <tr>
  <td style="width:5%">\(x)</td><td style="text-align:left;width:40%">-\xsize</td>
  <td style="text-align:center">\a</td><td  style="text-align:right;width:40%">\xsize</td>
  </tr>
  <tr>
  <td style="width:5%">\(f(x))</td><td style="text-align:center;width:40%">\embed{reply2}</td>
  <td style="text-align:center">||</td><td style="text-align:center;width:40%">\embed{reply3}</td>
  </tr>
  </table>
  </li>
}
\if{\step==2 and \casf!=5 and \n==1 }{
  ...
  <table class="wimsborder">
  <tr>
  <td style="width:5%">\(x)</td><td style="text-align:left;;width:40%">-\xsize</td><td style="text-align:center">\x1</td><td style="text-align:right;width:40%">\xsize</td>
  </tr><tr>
  <td style="width:5%">\(f(x))</td><td style="text-align:center;width:40%">\embed{reply2}</td><td style="text-align:center">0</td><td style="text-align:center;width:40%">\embed{reply3}</td>
  </tr>
  </table>
  </li>
}
\if{\step==2 and \casf==5 and \n==1 and \x1 < \a }{
  ...
  <table class="wimsborder">
  <tr>
  <td style="width:5%">\(x\)</td><td style="text-align:left;width:25%">-\xsize</td>
  <td style="width:5%" style="text-align:center">\x1</td><td style="width:25%">&nbsp;</td><td style="text-align:center;width:5%">\a</td><td style="text-align:right;width:25%">\xsize</td>
  </tr><tr>
  <td style="width:5%">\(f(x)\)</td><td style="text-align:center;width=25%">\embed{reply2}</td><td style="width:5%" style="text-align:center">0</td><td style="text-align:center;width:25%">\embed{reply3}</td><td style="text-align:center;width:5%">||</td>
  <td style="text-align:center;width:25%">\embed{reply4}</td>
  </tr>
  </table></li>
}
\if{\step==2 and \casf==5 and \n==1 and \a < \x1 }{<li style="margin-botton:5px">
  \name_enonce5 \name_enonce6 \a.<br> \name_enonce4 : \x1.
  </li><li>\name_complete:
  <table class="wimsborder">
  <tr>
  <td style="width:5%">\(x\)</td><td style="text-align:left;width:25%">-\xsize</td>
  <td style="text-align:center;width:5%">\a</td><td style="width:25%">&nbsp;</td><td style="text-align:center;width:5%">\x1</td><td style="text-align:right;width:20%">\xsize</td>
  </tr><tr>
  <td style="width:5%">\(f(x)\)</td><td style="text-align:center;width:20%">\embed{reply2}</td><td style="text-align:center;width:5%">||</td><td style="text-align:center;width:20%">\embed{reply3}</td><td style="text-align:center;width:5%">0</td>
  <td style="text-align:center;width:20%">\embed{reply4}</td>
  </tr>
  </table>
  </li>
}
\if{\step==2 and \n==2}{
  ...
  <tr>
  <td style="width:5%">\(x)</td><td style="text-align:left;width:25%">-\xsize</td>
  <td style="text-align:center;width:5%">\x1</td><td style="width:25%">&nbsp;</td><td style="text-align:center;width:5%">\x2</td><td style="text-align:right;width:25%">\xsize</td>
  </tr><tr>
  <td style="width:5%">\(f(x))</td><td style="text-align:center;width:25%">\embed{reply2}</td><td style="text-align:center;width:5%">0</td><td style="text-align:center;width:25%">\embed{reply3}</td><td style="text-align:center;width:5%">0</td>
  <td style="text-align:center;width:25%">\embed{reply4}</td>
  </tr>
  </table>
  </li>
...
\if{\step==2 and \n==3}{
  <li style="margin-botton:5px">
  \name_enonce7 \(x_1\), \(x_2\) \name_and \(x_3\) \name_in \(\mathcal{D}\).
  <br>\name_enonce8[1] \(x_1\), \(x_2\) \name_and \(x_3\) \name_enonce8[2]: \x1, \x2 \name_and \x3.
  </li><li><strong>\name_complete:</strong>

  <table class="wimsborder">
  <tr>
  <td>\(x)</td>
  <td style="text-align:left; width:20%">-\xsize</td>
  <td>\x1</td>
  <td style="width:20%">&nbsp;</td>
  <td>\x2</td>
  <td style="width:20%">&nbsp;</td>
  <td>\x3</td>
  <td style="text-align:right;width:20%">\xsize</td></tr>
  <tr>
  <td>\(f(x))</td>
  <td style="text-align:left">\embed{reply2}</td>
  <td>0</td>
  <td>\embed{reply3}</td>
  <td>0</td>
  <td>\embed{reply4}</td>
