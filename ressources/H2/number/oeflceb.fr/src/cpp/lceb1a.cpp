...
\answer{}{\Rep4}{type=raw}
\answer{}{\Rep5}{type=raw}
\answer{}{\Rep6}{type=raw}
...
\text{test1=\h1 notwordof 1 2 3 4 5 6 or \h2 notwordof 1 2 3 4 5 6 ? wims(append item 0 to \test1):wims(append item 1 to \test1)}
 ...
 \text{nstep=}
 \text{nstep=\step<\nt and  \N notitemof \data and abs(\goal - \N) < abs(\N - \d1[3]) and 0 notin \test1 and 0 notin \test3 ? r \step}
 \text{Feed=\t=1?\Feed
\d:\Feed
<span class="oefindbad">\d</font>}
