target= frise12
\title{Lettre en frise F1m}
\title_nl{Strookpatroongroep letters F1m}
\title_en{Frieze with letter F1m}
\title_it{Fregi con lettere F1m}
\title_es{Friso con letra F1m}
\title_ca{Fris amb lletra F1m}
