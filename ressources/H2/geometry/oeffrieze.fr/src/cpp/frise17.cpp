target=frise17
\title{Lettre en frise F2mg}
\title_nl{Strookpatroongroep letters F2mg}
\title_en{Frieze with letter F2mg}
\title_it{Fregi con lettere F2mg}
\title_es{Friso con letra F2mg}
\title_ca{Fris amb lletra F2mg}
