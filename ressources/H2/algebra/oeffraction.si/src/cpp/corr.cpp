...
\statement{Vsakega od ulomkov na levi pove¾ite 
s tistim ulomkom na desni, 
#ifdef INVERSE
ki predstavlja njegovo obratno vrednost.
#else
ki predstavlja isto ¹tevilo.
#endif
...
\reply{Ujemanje}{\left;\right}{type=correspond}
