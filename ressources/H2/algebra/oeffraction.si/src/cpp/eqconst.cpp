...
#include "header.inc"
#define TIT Sestavljanje enakosti
#if #TARGET (eqconst4)
# define CNT 4
#endif
#if #TARGET (eqconst5)
...
\statement{Iz danih ¹tevil sestavite dva enaka ulomka.
...
\answer{Numerator 1}{\r1;\big1\f1[1]\big2 \all}{type=dragfill}
\answer{Denominator 1}{\r2;\big1\f1[2]\big2}{type=dragfill}
\answer{Numerator 2}{\r3;\big1\f2[1]\big2}{type=dragfill}
\answer{Denominator 2}{\r4;\big1\f2[2]\big2}{type=dragfill}
