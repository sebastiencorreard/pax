...
# define INVERSE 1
 \title{TIT noemer bij de inverse}
 \text{name=noemer}
 \text{fill=random(2,4)}
 \text{op=&times;}
#endif
...
# define INVERSE 1
 \title{TIT teller bij de inverse}
 \text{name=teller}
 \text{fill=random(1,3)}
 \text{op=&times;}
#endif
...
\statement{Vul de \name in om gelijkheid te krijgen: 
