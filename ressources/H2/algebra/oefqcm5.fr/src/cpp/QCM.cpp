target= expnum01 expnum02 fract01
\author{JLuc DONADONI}
\email{jluc.donadoni@laposte.net}

#if #TARGET(expnum01)
\title{Expression numérique 1 - 5ème}
\text{consigne= Cliquez sur les bonnes réponses. <br><br>
Une seule bonne réponse par question <br><br>} 
\matrix{enr1=wims(record 1 of expnum01)}
\matrix{enr2=wims(record 2 of expnum01)}
\matrix{enr3=wims(record 3 of expnum01)}
\matrix{enr4=wims(record 4 of expnum01)}
\matrix{enr5=wims(record 5 of expnum01)}
#endif

#if #TARGET(expnum02)
\title{Expression numérique 2 - 5ème}
\text{consigne= Cliquez sur les bonnes réponses. <br><br>
Une seule bonne réponse par question <br><br>} 
\matrix{enr1=wims(record 1 of expnum02)}
\matrix{enr2=wims(record 2 of expnum02)}
\matrix{enr3=wims(record 3 of expnum02)}
\matrix{enr4=wims(record 4 of expnum02)}
\matrix{enr5=wims(record 5 of expnum02)}
#endif

#if #TARGET(fract01)
\title{Ecriture fractionnaire 1 - 5ème}
\text{consigne= Cliquez sur les bonnes réponses. <br><br>
Une seule bonne réponse par question <br><br>} 
\matrix{enr1=wims(record 1 of fract01)}
\matrix{enr2=wims(record 2 of fract01)}
\matrix{enr3=wims(record 3 of fract01)}
\matrix{enr4=wims(record 4 of fract01)}
\matrix{enr5=wims(record 5 of fract01)}
#endif
...
<tr ><td width=24%  align=center><b>QUESTIONS</b></td><td width=19% align=center><b>A</b></td>
<td width=19% align=center><b>B</b></td><td width=19% align=center><b>C</b></td>
<td width=19% align=center><b>D</b></td></b></tr>

<tr><td><b>\quest1</b></td>
\for{r=1 to 4}{<td align=center>\embed{r1,\r}</td>}</tr>

<tr><td><b>\quest2</b></td>
\for{r=1 to 4}{<td align=center>\embed{r2,\r}</td>}</tr>

<tr><td><b>\quest3</b></td>
\for{r=1 to 4}{<td align=center>\embed{r3,\r}</td>}</tr>

<tr><td><b>\quest4</b></td>
\for{r=1 to 4}{<td align=center>\embed{r4,\r}</td>}</tr>

<tr><td><b>\quest5</b></td>
\for{r=1 to 4}{<td align=center>\embed{r5,\r}</td>}</tr>
...
\solution{Dans le tableau,les bonnes réponses sont coloriées en vert, les mauvaises en rouge et les réponses oubliées en bleu}
