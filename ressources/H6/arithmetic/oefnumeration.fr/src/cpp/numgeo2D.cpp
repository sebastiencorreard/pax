...
\statement{<div>\name_statement
    <strong>(\nombre1,\nombre2)</strong> :</div>
<div class="wimscenter"> \embed{r1}
</div>}

\answer{}{\dessin;point,\point}{type=coord}

\if{\sc_reply1<1}{ \text{dessincorr=draw(500,500
\dessin1)
}
}
\feedback{\sc_reply1<1}{<div class="wimscenter">
<img src="\dessincorr" alt="">
</div>
