...
\integer{ec2=\et-\ec1}
\text{qcolor=randitem(\color1,\color2)}
...
<ul><li>
    \name_step1[1] \name_colors[\qcolor] \name_step1[2] \name_is\name_space:
\if{\step=1}{\embed{reply1,12}.}
\if{\step>1}{<span class="oef_indgood">\sol0</span>.
<span class="wims_emph">\name_replygood</span>
</li><li>\name_step2 \b1 \printcol1 \name_and \b2
 \printcol2 \name_is\name_space: }
\if{\step=2}{\embed{reply2,12}}
\if{\step>=3}{<span class="oef_indgood">\sol1</span>.
<span class="wims_emph">\name_replygood </span>
</li><li><div>
\name_the[2] \printcol1 \name_enum \c1 \name_and \name_the[4]
\name_colors[\color2] \name_enum \c2.
