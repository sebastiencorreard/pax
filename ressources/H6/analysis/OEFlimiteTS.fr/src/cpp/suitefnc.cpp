...
<tr style="border: solid black 1px;">
  ...
  <td style="width:15%;" style="text-align:right" rowspan="3" valign="\lstpos[3-\indf]"> \tb </td>
</tr>
</table>
}
...
<tr style="border:solid black 1px;">
  ...
  <td style="width:15%;text-align:left"> \xl[1]</td><td style="width:8%;"></td>
...
\steps{\mstep}
\statement{
On considère la fonction \(g) dont on connaît le tableau de variations:
<div class="wimscenter"> \tabg</div>
et les suites \((u_n)) et \((v_n)) telles que \(\lim u_n=\txb) et \(v_n=g(u_n)).
<p>
Déterminer \(\displaystyle\lim v_n).
</p>
\if{\step=1}
 {
Cette limite
