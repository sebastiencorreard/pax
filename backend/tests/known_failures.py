...
# ── Niveaux H1, H2, H5, H6 importés de WIMS le 2026-09-10 ─────────────────────
#
# **Non instruits** — le contraire de ce que ce fichier promet plus haut. Ce
# sont les échecs constatés par un balayage lent juste après la copie des
# modules, avant tout examen : 212 entrées, relevées telles quelles. Ils sont
# versés ici pour que la CI, qui balaie tout le corpus suivi par git, garde un
# signal lisible : une régression sur H3/H4 ou sur un exercice qui passait
# reste visible. Chacun est à instruire, puis à retirer d'ici.
#
...
_IMPORT_2026_09_10_CORRECT_SCORE: set[str] = {
    ...
    "H1~algebra~challenge2004.fr~src~age2",
    "H1~algebra~challenge2004.fr~src~controle",
    "H1~algebra~challenge2005.fr~src~2villes",
    "H1~algebra~challenge2005b.fr~src~Agedevin",
    "H1~algebra~frac5.fr~src~mult",
    ...
    "H5~analysis~oefderivee1S.fr~src~eqtgte2",
    "H5~analysis~oefderivee1S.fr~src~tgte2par",
    ...
    "H5~analysis~oefsequence.fr~src~somme_de_terme_consecutif_geometrique_et_limite",
    "H5~analysis~sincos.fr~src~valrem1",
    "H5~chemistry~oefperiodic.en~src~click1",
    "H5~chemistry~oefperiodic.fr~src~click1",
    "H5~chemistry~oefperiodic.nl~src~click1",
    "H5~geometry~OEFbarypdtsc.fr~src~cercletangent",
    ...
    "H6~arithmetic~OEFarithmTS.fr~src~crypto1",
    "H6~arithmetic~OEFarithmTS.fr~src~gauss1",
    "H6~arithmetic~OEFarithmTS.fr~src~gauss2",
    "H6~chemistry~formalKinetic.fr~src~vitessereaction",
    "H6~chemistry~piles.fr~src~piles",
    "H6~geometry~OEFeqdteplan.cn~src~paramplan2",
    "H6~geometry~OEFeqdteplan.fr~src~paramplan2",
...
_IMPORT_2026_09_10_WRONG_SCORE: set[str] = {
    "H1~algebra~oefratio.fr~src~ratio2",
    ...
    "H5~algebra~oeffonctaffine.fr~src~vedette2",
    "H5~analysis~oefparabole.fr~src~canon8",
    "H5~analysis~oefparabole.fr~src~canoniq",
    "H5~analysis~oefparabole.fr~src~fusee0",
    "H5~analysis~oefpercent1.fr~src~augm",
    "H5~analysis~oefpercent1.fr~src~brevet",
    "H5~analysis~oefpercent1.fr~src~coeff1",
    "H5~analysis~oefpercent1.fr~src~coeff2",
    "H5~analysis~oefpercent1.fr~src~college",
    "H5~analysis~oefpercent1.fr~src~percentdim",
    "H5~analysis~oefpercent1.fr~src~percentref2",
    "H5~analysis~oefpercent1.fr~src~percentref3",
    "H5~analysis~oefpercent1.fr~src~solde1",
    "H5~analysis~oefpercent1.fr~src~solde2",
    "H5~analysis~oefpercent2.fr~src~costume",
    "H5~analysis~oefpercent2.fr~src~evolution",
    "H5~analysis~oefpercent2.fr~src~lait",
    "H6~analysis~OEFCalcLimLnExp.en~src~calcexp",
    "H6~analysis~OEFCalcLimLnExp.en~src~calcln",
    "H6~analysis~OEFCalcLimLnExp.en~src~indeterminateForm",
    "H6~analysis~OEFCalcLimLnExp.fr~src~calcexp",
    "H6~analysis~OEFCalcLimLnExp.fr~src~calcln",
    "H6~analysis~OEFCalcLimLnExp.fr~src~indeterminateForm",
    "H6~analysis~OEFCalcLimLnExp.fr~src~indformwithexp",
    "H6~analysis~OEFCalcLimLnExp.fr~src~indformwithln",
    "H6~analysis~OEFCalcLimLnExp.nl~src~calcexp",
    "H6~analysis~OEFCalcLimLnExp.nl~src~calcln",
    "H6~analysis~OEFCalcLimLnExp.nl~src~indeterminateForm",
    "H6~analysis~oeflimite.fr~src~aff_exp",
    "H6~analysis~oeflimite.fr~src~formules",
    "H6~analysis~oeflimite.fr~src~formules0",
    "H6~analysis~oeflimite.fr~src~formules02",
...
_IMPORT_2026_09_10_CONSTANT_SCORE: set[str] = {
    ...
    "H1~francais~oefvocmarine.fr~src~jeuniv3",
    "H1~francais~oefvocmarine.fr~src~jeuniv4",
    "H2~number~oeflceb.fr~src~lceb1a",
    "H2~number~oeflceb.fr~src~lceb1b",
    "H2~number~oeflceb.fr~src~lceb2b",
    "H5~algebra~oefgeoesp.fr~src~droiteperp",
    "H5~algebra~oefgeoesp.fr~src~drtparam",
    "H5~analysis~foncpluvares.fr~src~kermat",
    "H5~analysis~oefparabole.fr~src~fuseerep",
    "H5~analysis~oefratexp.fr~src~cube",
    "H5~analysis~oefratexp.fr~src~frequence",
}
