...
def load_and_render(
    ...
    # Pas de `.def` : rien à rendre. PAX ne rend **que** des `.def` — le
    # parseur OEF qui servait ici de repli n'était plus exécuté par aucun des
    # 4 277 exercices du corpus, tous compilés, et il a été retiré.
    raise FileNotFoundError(f"Aucun .def pour {oef_path}")
