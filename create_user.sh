...
#   ./create_user.sh --email bob@example.com   --first-name Bob   --last-name Martin --role student --uai 0132401P
#   ./create_user.sh --email bob@example.com   --first-name Bob   --password bob1234
#
# --uai  UAI de l'établissement (défaut : 0132401P). Ignoré pour --role guest.
#
